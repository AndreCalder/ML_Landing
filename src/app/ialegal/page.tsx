    ...
    <div className="pt-12 min-h-svh h-fit w-full">
      ...
      <div className="min-h-[28rem] grid grid-cols-12 py-6 px-5 sm:px-24 gap-4">
        <div className="col-span-12 flex flex-col justify-center items-center ">
          <p className="text-2xl lg:text-4xl text-center text-ml_orange font-bold">
            Orientación Jurídica Inmediata con Mar
            <span className="text-ml_blue">+ia</span>
          </p>
          <p className="font-extralight text-center my-6 text-md sm:text-lg">
            Resuelve tus{" "}
            <span className="font-extrabold">
              dudas legales en Materia Familiar HOY.
            </span>{" "}
            Llamada directa con IA especializada, respaldada por nuestro
            despacho jurídico.
          </p>
      ...
      <div className="w-full h-[20rem] solicitaBg grid grid-cols-12 px-5 sm:px-24">
        <div className="col-span-12 sm:col-span-6 flex flex-col gap-y-4 justify-center items-start">
          ...
          <button className="bg-ml_orange text-white font-extrabold rounded-full w-fit px-4 py-2 cursor-pointer transition-transform hover:scale-105">
            Quiero mi asesoría
          </button>
        </div>
      </div>
      <div className="min-h-[28rem] grid grid-cols-12 pt-6 px-5 sm:px-24 gap-4">
        <div className="col-span-12 lg:col-span-6 flex flex-col justify-center items-start pb-6">
          ...
          <p className="font-extralight text-center lg:text-left my-6 text-md sm:text-lg">
            Mar+ia es tu asistente legal inteligente,{" "}
            <span className="font-extrabold">
      ...
      >
        <div className="col-span-12 lg:col-span-7 flex flex-col justify-center items-start gap-y-4 py-12">
          ...
          <button className="bg-ml_orange text-white font-extrabold rounded-full w-fit px-6 py-3 cursor-pointer transition-transform hover:scale-105 mt-6">
      ...
      <div className="w-full h-[18rem] solicitaBG2 sm:px-24 flex flex-col justify-center items-center gap-y-4">
        <div className="w-full h-full lg:h-fit lg:w-fit px-5 sm:px-0 flex flex-col justify-center items-start gap-y-4 bg-black/30 sm:bg-transparent">
          ...
          <button className="bg-ml_blue text-white font-extrabold rounded-full w-fit px-4 py-2 cursor-pointer transition-transform hover:scale-105">
