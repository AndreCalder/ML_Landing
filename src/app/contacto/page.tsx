...
function Contacto() {
  ...
  const sendContact = async () => {
    if (
      ...
      toast.error(
        "Por favor, llena todos los campos y acepta el aviso de privacidad"
      );
      return;
    }
        ...
        <div className="h-full w-full px-5 sm:pl-24 py-4 flex flex-col items-center justify-center gap-5">
          ...
          <div className="w-full grid grid-cols-12 gap-4">
            ...
            <div className="col-span-12 hidden">
              <div className="flex flex-col space-y-1.5">
                <Label className="font-extralight" htmlFor="message">
                  Asunto*
                </Label>
                <Input
                  id="business"
            ...
            <div className="col-span-12 w-full flex items-center justify-center">
              <div className="flex items-center space-x-2">
                <Checkbox
                  className="border-ml_orange data-[state=checked]:bg-ml_orange rounded-md"
                  checked={checked}
                  onCheckedChange={(e) => {
                ...
                >
                  He leído y estoy de acuerdo en el manejo de mis datos
                  personales con base en el Aviso de Privacidad.
                </label>
              </div>
            </div>
          </div>
          ...
          {!sent && (
            <div
              onClick={() => sendContact()}
              className="w-fit bg-ml_blue text-white font-bold text-base text-center rounded-full my-4 py-2 px-4 cursor-pointer transition-all hover:scale-105"
            >
              Enviar
            </div>
          )}
        ...
        <div className="w-full h-fit px-6 py-3 bg-white rounded-tl-[65px] rounded-bl-[65px] hidden lg:flex flex-col xl:justify-around xl:flex-row gap-5">
          ...
          <div className="hidden xl:flex items-center">
            <Image
              ...
              height={40}
            />
            <p className="ml-2 text-xs text-ml_blue">
